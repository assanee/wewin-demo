...
| — | จัดการผู้ใช้ · กลุ่มและสิทธิ์ · ระงับบัญชี | ✅ |
| — | ตั้งค่าบัญชีตัวเอง · เปลี่ยนรหัสผ่าน · จัดการ provider และอุปกรณ์ | ✅ |
| — | MFA | ⚠️ **ยังไม่ทำ** — แผนอยู่ในข้อ 6.4 |
...
ทั้ง workspace **2,698 เคส** · `@wewin/core` 339 · `@wewin/i18n` 199 · `@wewin/contract` 90
· `@wewin/db` 313 · `@wewin/web` 293 · `@wewin/dashboard` 141 · `@wewin/api` 1,323
