...
export const TH: Catalogue = {
  ...
  'error.taxdoc.disabled':
    'ยังไม่ได้เปิดใช้เอกสารภาษี — เปิดที่หน้าข้อมูลบริษัทก่อนจึงจะออกเอกสารได้',
  'error.taxdoc.kind_not_permitted':
    'เอกสารชนิดนี้ยังไม่ได้เปิดใช้ในหน้าตั้งค่า',
  'error.taxdoc.credit_note_via_void':
    'ใบลดหนี้ออกด้วยการยกเลิกเอกสารเดิมเท่านั้น — เลือกเอกสารที่ต้องการยกเลิกแล้วระบุเหตุผล',
  'error.taxdoc.no_seller_profile':
    'ยังไม่ได้กรอกชื่อและที่อยู่บริษัทในหน้าข้อมูลบริษัท — เอกสารภาษีต้องมีข้อมูลผู้ขาย',
  'error.taxdoc.no_quotation':
    'ออเดอร์นี้ยังไม่มีใบเสนอราคาที่ตรึงไว้ — ออกเอกสารภาษีจากยอดที่ตกลงกันแล้วเท่านั้น',
  'error.taxdoc.no_bill_to':
    'ยังไม่ได้กรอกข้อมูลผู้ซื้อ — ใบกำกับภาษีต้องมีชื่อและที่อยู่ผู้ซื้อ',
  'error.taxdoc.instalment_unknown':
    'ไม่พบงวดที่ระบุในออเดอร์นี้',
