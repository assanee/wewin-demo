...
export function App() {
  return (
    // Above the routes, and deliberately not inside the configurator: the display
    // unit follows the customer from the catalogue to the configurator to the quote,
    // and choosing one is a way of reading a number, never an edit — which is why it
    // sits outside the configurator's undo history rather than in its state.
    <DisplayUnitProvider>
      <QuoteProvider>
        <ToastProvider>
