...
export const de: PartialUiCatalogue = {
  ...
  'orderActions.heading': 'Diese Bestellung verwalten',
  'orderActions.object.title': 'Änderung anfragen',
  'orderActions.object.body':
    'Wenn etwas nicht stimmt, fragen Sie zuerst eine Änderung an. Die Bestellung geht nicht in die Produktion, bevor unsere Mitarbeiter geantwortet haben, und es wird nichts einbehalten.',
  'orderActions.object.noteLabel': 'Was geändert werden soll',
  'orderActions.object.notePlaceholder': 'Zum Beispiel: Farbe auf Schwarz ändern oder Breite um 10 cm verringern.',
  'orderActions.object.submit': 'Anfrage senden',
  'orderActions.object.sending': 'Wird gesendet…',
  'orderActions.object.sent': 'Ihre Änderungsanfrage wurde gesendet. Unser Vertrieb meldet sich bei Ihnen.',
  'orderActions.object.open': ({ openedAt }) => `Eine Änderungsanfrage wartet auf Antwort, gesendet am ${openedAt}`,
  'orderActions.object.openBody':
    'Diese Bestellung geht erst in die Produktion, wenn sie beantwortet ist. Falls Sie sie versehentlich gesendet haben, können Sie sie zurückziehen.',
  'orderActions.object.withdraw': 'Anfrage zurückziehen',
  'orderActions.object.withdrawing': 'Wird zurückgezogen…',
  'orderActions.object.withdrawn': 'Ihre Änderungsanfrage wurde zurückgezogen.',
  'orderActions.cancel.title': 'Diese Bestellung stornieren',
  ...
  'orderActions.cancel.refund': ({ refundMinor }, f) => `${f.bahtExact(refundMinor)} würden Sie zurückerhalten`,
  'orderActions.cancel.freeCancellation': 'Sie können ohne Einbehalt stornieren — der volle Betrag kommt zurück.',
  'orderActions.cancel.noMoney': 'Es ist keine Zahlung eingegangen, es gibt also nichts einzubehalten oder zurückzuzahlen.',
  'orderActions.cancel.reasonLabel': 'Warum stornieren Sie?',
  'orderActions.cancel.reasonPlaceholder': 'Zum Beispiel: anders entschieden, oder das Projekt ist verschoben.',
  'orderActions.cancel.confirm': 'Storierung bestätigen',
  'orderActions.cancel.cancelling': 'Wird storniert…',
  'orderActions.cancel.keep': 'Bestellung behalten',
  'orderActions.cancel.done': 'Diese Bestellung wurde storniert.',
  'orderActions.problem.unconfigured': 'Diese Website ist nicht vollständig konfiguriert. Bitte wenden Sie sich an unseren Vertrieb.',
  'orderActions.problem.unreachable': 'Das System war nicht erreichbar. Bitte versuchen Sie es erneut.',
  'orderActions.problem.unauthorized': 'Ihre Sitzung ist abgelaufen. Bitte melden Sie sich erneut an.',
  'orderActions.problem.refused': 'Das war nicht möglich.',
  'orderActions.problem.malformed': 'Die Antwort des Systems war nicht lesbar. Bitte versuchen Sie es erneut.',
  ...
  'payment.form.imageChoose': 'Foto auswählen',
  'payment.form.imageChange': 'Foto ändern',
  ...
  'payment.history.submitted': (p, f) => `${f.bahtExact(p.slipMinor)} · gesendet am ${f.date(p.sentAt)} · wird geprüft`,
  'payment.history.accepted': (p, f) => `${f.bahtExact(p.slipMinor)} · gesendet am ${f.date(p.sentAt)} · akzeptiert`,
  'payment.history.rejected': (p, f) => `${f.bahtExact(p.slipMinor)} · nicht akzeptiert — ${p.reason}`,
