...
export const hi: PartialUiCatalogue = {
  ...
  'home.pricing.formula.note':
    'विकल्पों में प्रोफ़ाइल का रंग, काँच का रंग और मोटाई, तथा आपके जोड़े गए हार्डवेयर आते हैं। इनमें से हर एक मूल्य पृष्ठ पर अलग से दिया गया है।',
  ...
  'configure.futureQuote': 'कोटेशन मँगाने की सुविधा अगले संस्करण में आएगी।',
  ...
  'about.stance.itemised.body':
    'मूल्य पृष्ठ कुल बनाने वाली हर मद देता है — क्षेत्रफल, रंग, काँच और हार्डवेयर। आँकड़ा बदले तो आप देख सकते हैं कि किससे बदला।',
  ...
  'review.form.intro':
    'एल्युमिनियम को एक बरसात के बाद परखा जाता है, लगने के तीन दिन बाद नहीं — जब तैयार हों तब लिखिए। यह कभी बंद नहीं होता।',
  ...
  'orderActions.cancel.preFreezeNote': 'यह ऑर्डर उत्पादन में नहीं गया है। एल्युमिनियम अभी नहीं काटा गया है।',
  'orderActions.cancel.postFreezeNote':
    '⚠️ यह ऑर्डर उत्पादन में जा चुका है — एल्युमिनियम आपके डिज़ाइन के अनुसार काटा जा चुका है। अब रद्द करने पर, अनुबंध के समय तय नीति के अनुसार कुछ राशि रोक ली जाएगी।',
  ...
  'settings.intro':
    'चुनिए कि यह साइट आपके लिए कैसे लिखी जाए: भाषा, माप की इकाई और मुद्रा। तीनों केवल प्रस्तुति हैं — आपके भरे नाप और हमारे निकाले मूल्य इनसे नहीं बदलते।',
  ...
  'settings.currency.why':
    'हर मूल्य थाई बाट में निकाला और रखा जाता है, और उत्पाद पृष्ठ एक बार बनकर हर आगंतुक में साझा होते हैं, इसलिए उन पर व्यक्ति-विशेष मुद्रा नहीं लगाई जा सकती। विदेशी ग्राहक को उनकी अपनी मुद्रा में कोटेशन देना अलग विषय है और अभी चालू नहीं है।',
