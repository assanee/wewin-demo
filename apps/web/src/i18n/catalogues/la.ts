...
export const la: PartialUiCatalogue = {
  ...
  'orderActions.cancel.preFreezeNote': 'ໃບສັ່ງຊື້ນີ້ຍັງບໍ່ເຂົ້າສາຍການຜະລິດ. ຍັງບໍ່ໄດ້ຕັດອາລູມິນຽມ.',
  'orderActions.cancel.postFreezeNote':
    '⚠️ ໃບສັ່ງຊື້ນີ້ເຂົ້າສາຍການຜະລິດແລ້ວ — ອາລູມິນຽມຖືກຕັດຕາມແບບຂອງທ່ານແລ້ວ. ການຍົກເລີກຕອນນີ້ຈະມີການຫັກເງິນຕາມນະໂຍບາຍທີ່ຕົກລົງກັນເມື່ອເຮັດສັນຍາ.',
