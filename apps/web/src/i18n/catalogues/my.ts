...
export const my: PartialUiCatalogue = {
  ...
  'orderActions.cancel.preFreezeNote': 'ဤအော်ဒါသည် ထုတ်လုပ်မှုအတွင်း မဝင်သေးပါ။ အလူမီနီယမ်ကို မဖြတ်သေးပါ။',
  'orderActions.cancel.postFreezeNote':
    '⚠️ ဤအော်ဒါသည် ထုတ်လုပ်မှုအတွင်း ဝင်ရောက်ပြီးပါပြီ — အလူမီနီယမ်ကို သင့်ဒီဇိုင်းအတိုင်း ဖြတ်ပြီးပါပြီ။ ယခု ပယ်ဖျက်ပါက စာချုပ်ချုပ်ဆိုစဉ် သဘောတူထားသည့် စည်းမျဉ်းအရ ငွေအချို့ကို ထားရှိမည် ဖြစ်ပါသည်။',
