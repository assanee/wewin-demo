...
export const my: PartialUiCatalogue = {
  ...
  'home.pricing.formula.note':
    'ရွေးချယ်စရာများတွင် ဘောင်အရောင်၊ ဘောင်အတွင်း ထည့်သွင်းသည့်အရာ (မှန်၊ လိုဗာပြား သို့မဟုတ် ဇကာ)၊ ထပ်ထည့်သောပစ္စည်းများ ပါဝင်သည်။ တစ်ခုစီကို စျေးနှုန်းစာမျက်နှာတွင် သီးခြားစီ ဖော်ပြထားသည်။',
  ...
  'configure.quoteNext':
    'စျေးနှုန်းစာရင်းသို့ ထည့်ပြီး ထိုစာမျက်နှာမှ စျေးနှုန်းစာရွက် တောင်းခံနိုင်ပါသည်။',
  ...
  'about.stance.itemised.body':
    'စျေးနှုန်းစာမျက်နှာသည် စုစုပေါင်းကိုဖွဲ့စည်းသည့် အချက်တိုင်းကို ဖော်ပြသည် — ဧရိယာ၊ အရောင်၊ ဘောင်အတွင်းထည့်သွင်းသည့်အရာနှင့် ပစ္စည်းများ။ ဂဏန်းပြောင်းလျှင် ဘာကြောင့်ပြောင်းသည်ကို သင်မြင်နိုင်သည်။',
  ...
  'review.form.intro':
    'အမှာအရ ပြုလုပ်သောအလုပ်ကို တပ်ပြီး သုံးရက်အကြာမဟုတ်ဘဲ မိုးရာသီတစ်ခုပြီးမှ ဆုံးဖြတ်သည် — အဆင်သင့်ဖြစ်သည့်အခါ ရေးပါ။ ဤနေရာ ဘယ်တော့မှမပိတ်ပါ။',
  ...
  'product.gallery.show': (p, f) => `ဓာတ်ပုံ ${f.integer(p.position)} ကြည့်ရန်`,
  ...
  'orderActions.heading': 'ဤအော်ဒါကို စီမံမည်',
  'orderActions.object.title': 'ပြင်ဆင်ရန် တောင်းဆိုမည်',
  'orderActions.object.body':
    'မှားနေသည်ရှိပါက ပြင်ဆင်ရန် အရင်တောင်းဆိုနိုင်ပါသည်။ ဝန်ထမ်းများ ပြန်မဖြေမချင်း အော်ဒါသည် ထုတ်လုပ်မှုအတွင်း မဝင်ပါ၊ ငွေလည်း ဖြတ်တောက်မည် မဟုတ်ပါ။',
  'orderActions.object.noteLabel': 'ပြင်ဆင်လိုသည့် အကြောင်းအရာ',
  'orderActions.object.notePlaceholder': 'ဥပမာ — အနက်ရောင် ပြောင်းလိုသည်၊ သို့မဟုတ် အလျားကို ၁၀ စင်တီမီတာ လျှော့လိုသည်။',
  'orderActions.object.submit': 'တောင်းဆိုချက် ပေးပို့မည်',
  'orderActions.object.sending': 'ပေးပို့နေသည်…',
  'orderActions.object.sent': 'ပြင်ဆင်ရန် တောင်းဆိုချက် ပေးပို့ပြီးပါပြီ။ အရောင်းအဖွဲ့မှ ဆက်သွယ်ပါမည်။',
  'orderActions.object.open': ({ openedAt }) => `ပြင်ဆင်ရန် တောင်းဆိုချက်တစ်ခု အဖြေကို စောင့်ဆိုင်းနေသည်၊ ${openedAt} တွင် ပေးပို့ခဲ့သည်`,
  'orderActions.object.openBody':
    'အဖြေမရမချင်း ဤအော်ဒါသည် ထုတ်လုပ်မှုအတွင်း မဝင်ပါ။ မှားပေးပို့မိပါက ပြန်ရုပ်သိမ်းနိုင်ပါသည်။',
  'orderActions.object.withdraw': 'တောင်းဆိုချက် ပြန်ရုပ်သိမ်းမည်',
  'orderActions.object.withdrawing': 'ရုပ်သိမ်းနေသည်…',
  'orderActions.object.withdrawn': 'ပြင်ဆင်ရန် တောင်းဆိုချက်ကို ပြန်ရုပ်သိမ်းပြီးပါပြီ။',
  'orderActions.cancel.title': 'ဤအော်ဒါကို ပယ်ဖျက်မည်',
  'orderActions.cancel.body':
    'ပယ်ဖျက်ပြီးပါက ပြန်ပြောင်းလို့ မရပါ။ ပြန်မှာလိုပါက စျေးနှုန်းစာရွက်အသစ် စတင်ရပါမည်။',
  'orderActions.cancel.start': 'အော်ဒါ ပယ်ဖျက်ရန် တောင်းဆိုမည်',
  'orderActions.cancel.preFreezeNote': 'ဤအော်ဒါသည် ထုတ်လုပ်မှုအတွင်း မဝင်သေးပါ။ သင့်ဒီဇိုင်းအတိုင်း ဘာမှ ထုတ်လုပ်ထားခြင်း မရှိသေးပါ။',
  'orderActions.cancel.postFreezeNote':
    '⚠️ ဤအော်ဒါသည် ထုတ်လုပ်မှုအတွင်း ဝင်ရောက်ပြီးပါပြီ — စက်ရုံသည် သင့်ဒီဇိုင်းအတိုင်း ထုတ်လုပ်ခြင်းကို စတင်ပြီးပါပြီ။ ယခု ပယ်ဖျက်ပါက စာချုပ်ချုပ်ဆိုစဉ် သဘောတူထားသည့် စည်းမျဉ်းအရ ငွေအချို့ကို ထားရှိမည် ဖြစ်ပါသည်။',
  'orderActions.cancel.pricing': 'ပမာဏ တွက်ချက်နေသည်…',
  'orderActions.cancel.held': ({ heldMinor }, f) => `ကျွန်ုပ်တို့ ထားရှိသည့် ငွေ ${f.bahtExact(heldMinor)}`,
  'orderActions.cancel.forfeit': ({ forfeitMinor }, f) => `${f.bahtExact(forfeitMinor)} ကို ထားရှိမည်`,
  'orderActions.cancel.refund': ({ refundMinor }, f) => `${f.bahtExact(refundMinor)} ကို ပြန်အမ်းမည်`,
  'orderActions.cancel.freeCancellation': 'ငွေမဖြတ်ဘဲ ပယ်ဖျက်နိုင်ပါသည် — အပြည့်အဝ ပြန်အမ်းပါမည်။',
  'orderActions.cancel.noMoney': 'ငွေပေးချေမှု မရရှိသေးသဖြင့် ထားရှိရန် သို့မဟုတ် ပြန်အမ်းရန် မရှိပါ။',
  'orderActions.cancel.reasonLabel': 'ပယ်ဖျက်ရသည့် အကြောင်းရင်း',
  'orderActions.cancel.reasonPlaceholder': 'ဥပမာ — စိတ်ပြောင်းသွားသည်၊ သို့မဟုတ် စီမံကိန်း ရွှေ့ဆိုင်းသည်။',
  'orderActions.cancel.confirm': 'ပယ်ဖျက်မှုကို အတည်ပြုမည်',
  'orderActions.cancel.cancelling': 'ပယ်ဖျက်နေသည်…',
  'orderActions.cancel.keep': 'ပယ်ဖျက်မည် မဟုတ်ပါ',
  'orderActions.cancel.done': 'ဤအော်ဒါကို ပယ်ဖျက်ပြီးပါပြီ။',
  'orderActions.problem.unconfigured': 'ဤဝဘ်ဆိုက် ပြင်ဆင်မှု မပြီးဆုံးသေးပါ။ အရောင်းအဖွဲ့ကို ဆက်သွယ်ပါ။',
  'orderActions.problem.unreachable': 'စနစ်ကို ဆက်သွယ်လို့ မရပါ။ ထပ်စမ်းကြည့်ပါ။',
  'orderActions.problem.unauthorized': 'သင်၏ session သက်တမ်း ကုန်ဆုံးပါပြီ။ ပြန်လည် အကောင့်ဝင်ပါ။',
  'orderActions.problem.refused': 'ဤအရာကို ဆောင်ရွက်လို့ မရပါ။',
  'orderActions.problem.malformed': 'စနစ်၏ အဖြေကို ဖတ်လို့ မရပါ။ ထပ်စမ်းကြည့်ပါ။',

  /* ---- Display settings ---------------------------------------------------- */
  'settings.nav': 'ပြသမှု',
  'settings.heading': 'ပြသမှုဆက်တင်များ',
  'settings.intro':
    'ဤဆိုက်ကို သင့်အတွက် မည်သို့ရေးသားမည်ကို ရွေးပါ — ဘာသာစကားနှင့် တိုင်းတာမှုယူနစ်။ နှစ်ခုလုံးသည် ပြသမှုသက်သက်ဖြစ်သည် — သင်ထည့်သောအတိုင်းအတာများနှင့် ကျွန်ုပ်တို့တွက်ချက်သောစျေးနှုန်းများ ပြောင်းလဲမည်မဟုတ်ပါ။ ငွေကြေးကို ဤစာမျက်နှာတွင် ရွေးချယ်နိုင်ခြင်းမရှိပါ — အကြောင်းရင်းကို အောက်တွင် ဖော်ပြထားသည်။',
  ...
  'settings.currency.why':
    'စျေးနှုန်းတိုင်းကို ထိုင်းဘတ်ဖြင့် တွက်ချက်၍ သိမ်းဆည်းထားပြီး ကုန်ပစ္စည်းစာမျက်နှာများကို တစ်ကြိမ်တည်းတည်ဆောက်၍ လာရောက်သူတိုင်း မျှဝေသုံးသဖြင့် လူတစ်ဦးချင်းအလိုက် ငွေကြေးကို အသုံးမပြုနိုင်ပါ။ စျေးနှုန်းစာရွက်မှာ ကွာသည် — အခြားငွေကြေးဖြင့် စျေးနှုန်းပေးရန် သတ်မှတ်ထားသော ပို့ဆောင်ရမည့်နိုင်ငံအတွက် စျေးနှုန်းစာရွက်ကို ထိုငွေကြေးဖြင့် ထုတ်ပေးပြီး စာရွက်စာတမ်းပေါ်တွင် သတ်မှတ်ပြီးသော လဲလှယ်နှုန်းကို အသုံးပြုသည်၊ ပေးချေမှုမှာ ဘတ်ဖြင့် ဖြစ်ပါသည်။',
  ...
  'payment.awaitingConfirmation': 
    'သင့်စျေးနှုန်းစာရွက်ကို စစ်ဆေးနေပါသည်။ ဖော်ပြထားသောပမာဏမှာ ခန့်မှန်းချက်သာဖြစ်ပြီး — ကျွန်ုပ်တို့အဖွဲ့မှ အတည်ပြုပြီး ငွေမပေးချေမီ အကြောင်းကြားပါမည်။',
