...
export const th: UiCatalogue = {
  ...
  'orderActions.cancel.preFreezeNote': 'คำสั่งซื้อนี้ยังไม่เข้าสายการผลิต ยังไม่มีการตัดอะลูมิเนียม',
  'orderActions.cancel.postFreezeNote':
    '⚠️ คำสั่งซื้อนี้เข้าสายการผลิตแล้ว — อะลูมิเนียมถูกตัดตามแบบของคุณไปแล้ว การยกเลิกตอนนี้จึงมีการหักเงินตามนโยบายที่ตกลงไว้ตอนทำสัญญา',
