...
export const th: UiCatalogue = {
  ...
  'home.pricing.formula.note':
    'ค่าออปชันคือสีโปรไฟล์ สิ่งที่ใส่ในบาน — กระจก ใบระแนง หรือมุ้ง — และอุปกรณ์ที่เลือกเพิ่ม ทุกบรรทัดแสดงแยกให้เห็นในหน้าคำนวณราคา',
  ...
  'about.stance.itemised.body':
    'หน้าคำนวณราคาแสดงทุกบรรทัดที่ประกอบกันเป็นยอด ทั้งค่าพื้นที่ ค่าสี ค่าสิ่งที่ใส่ในบาน และค่าอุปกรณ์ ถ้าตัวเลขเปลี่ยน จะเห็นว่าเปลี่ยนเพราะอะไร',
  ...
  'review.form.intro':
    'งานสั่งทำตัดสินกันหลังผ่านฝนไปรอบหนึ่ง ไม่ใช่หลังติดตั้งสามวัน — เขียนได้ทุกเมื่อ ไม่มีวันหมดอายุ',
  ...
  'quotation.fx.settlementNote': ({ currency }) => `ยอด ${currency} ข้างต้นเป็นราคาอ้างอิง ชำระเงินจริงเป็นเงินบาทตามยอดนี้`,
  'quotation.fx.payable': 'ยอดที่ต้องชำระ',
  'quotation.fx.deposit': 'ชำระมัดจำก่อน',
  ...
  'orderActions.heading': 'จัดการคำสั่งซื้อนี้',
  'orderActions.object.title': 'ขอแก้ไขคำสั่งซื้อ',
  'orderActions.object.body':
    'ถ้ามีอะไรไม่ถูกต้อง ส่งคำขอแก้ไขมาก่อนได้ คำสั่งซื้อจะยังไม่เข้าสายการผลิตจนกว่าเจ้าหน้าที่จะตอบกลับ และไม่มีการหักเงินใด ๆ',
  'orderActions.object.noteLabel': 'สิ่งที่ต้องการให้แก้',
  'orderActions.object.notePlaceholder': 'เช่น ขอเปลี่ยนสีเป็นสีดำ หรือขอลดความกว้างลง 10 ซม.',
  'orderActions.object.submit': 'ส่งคำขอแก้ไข',
  'orderActions.object.sending': 'กำลังส่ง…',
  'orderActions.object.sent': 'ส่งคำขอแก้ไขแล้ว ฝ่ายขายจะติดต่อกลับ',
  'orderActions.object.open': ({ openedAt }) => `มีคำขอแก้ไขที่ยังรอคำตอบ ส่งเมื่อ ${openedAt}`,
  'orderActions.object.openBody':
    'คำสั่งซื้อนี้จะยังไม่เข้าสายการผลิตจนกว่าจะมีคำตอบ ถ้าส่งผิดหรือไม่ต้องการแก้แล้ว ถอนคำขอได้',
  'orderActions.object.withdraw': 'ถอนคำขอแก้ไข',
  'orderActions.object.withdrawing': 'กำลังถอน…',
  'orderActions.object.withdrawn': 'ถอนคำขอแก้ไขแล้ว',
  'orderActions.cancel.title': 'ยกเลิกคำสั่งซื้อ',
  'orderActions.cancel.body': 'ยกเลิกแล้วย้อนกลับไม่ได้ ถ้าต้องการสั่งใหม่ต้องเริ่มใบใหม่',
  'orderActions.cancel.start': 'ขอยกเลิกคำสั่งซื้อ',
  'orderActions.cancel.preFreezeNote': 'คำสั่งซื้อนี้ยังไม่เข้าสายการผลิต ยังไม่ได้เริ่มทำตามแบบของคุณ',
  'orderActions.cancel.postFreezeNote':
    '⚠️ คำสั่งซื้อนี้เข้าสายการผลิตแล้ว — โรงงานเริ่มผลิตตามแบบของคุณไปแล้ว การยกเลิกตอนนี้จึงมีการหักเงินตามนโยบายที่ตกลงไว้ตอนทำสัญญา',
  'orderActions.cancel.pricing': 'กำลังคิดยอดเงิน…',
  'orderActions.cancel.held': ({ heldMinor }, f) => `เงินที่บริษัทถือไว้ ${f.bahtExact(heldMinor)}`,
  'orderActions.cancel.forfeit': ({ forfeitMinor }, f) => `จะถูกหักไว้ ${f.bahtExact(forfeitMinor)}`,
  'orderActions.cancel.refund': ({ refundMinor }, f) => `จะได้คืน ${f.bahtExact(refundMinor)}`,
  'orderActions.cancel.freeCancellation': 'ยกเลิกได้โดยไม่มีการหักเงิน คืนเต็มจำนวน',
  'orderActions.cancel.noMoney': 'ยังไม่มีการชำระเงินเข้ามา จึงไม่มีเงินที่ต้องคืนหรือถูกหัก',
  'orderActions.cancel.reasonLabel': 'เหตุผลที่ยกเลิก',
  'orderActions.cancel.reasonPlaceholder': 'เช่น เปลี่ยนใจ หรือเลื่อนโครงการออกไป',
  'orderActions.cancel.confirm': 'ยืนยันการยกเลิก',
  'orderActions.cancel.cancelling': 'กำลังยกเลิก…',
  'orderActions.cancel.keep': 'ไม่ยกเลิก',
  'orderActions.cancel.done': 'ยกเลิกคำสั่งซื้อแล้ว',
  'orderActions.problem.unconfigured': 'ระบบยังตั้งค่าไม่ครบ ติดต่อฝ่ายขายได้เลย',
  'orderActions.problem.unreachable': 'ติดต่อระบบไม่ได้ ลองอีกครั้ง',
  'orderActions.problem.unauthorized': 'เซสชันหมดอายุ กรุณาเข้าสู่ระบบอีกครั้ง',
  'orderActions.problem.refused': 'ทำรายการนี้ไม่ได้',
  'orderActions.problem.malformed': 'อ่านคำตอบจากระบบไม่ได้ ลองอีกครั้ง',
  ...
  /*
   * ⚠️ ไม่ใช่ "ชำระครบแล้ว" — ออเดอร์ที่ยกเลิกไปแล้วก็เข้าเงื่อนไขนี้ และบริษัทอาจเป็นฝ่ายที่ต้องคืนเงินให้ลูกค้า
   * ประโยคนี้จึงบอกเพียงว่าหน้านี้รับแจ้งชำระเงินไม่ได้แล้ว และชี้ไปที่คนที่ตอบเรื่องยอดเงินได้ — คำที่ใช้มาจาก
  ...
  'payment.awaitingConfirmation': 'ใบเสนอราคาของท่านอยู่ระหว่างการตรวจสอบ ยอดที่แสดงยังเป็นราคาประมาณ — ทีมงานจะยืนยันและแจ้งให้ท่านทราบก่อนชำระเงิน',
