...
/**
 * Vietnamese (Tiếng Việt) — **empty on purpose, and empty is a state this app supports.**
 *
 ...
 *
 * So this locale ships working and incomplete. Choosing it today gives Vietnamese
