...
export const zh: PartialUiCatalogue = {
  ...
  'orderActions.heading': '管理此订单',
  'orderActions.object.title': '申请修改',
  'orderActions.object.body':
    '如有不妥，可先提出修改申请。在我们的工作人员答复之前，订单不会进入生产，也不会扣除任何款项。',
  'orderActions.object.noteLabel': '需要修改的内容',
  'orderActions.object.notePlaceholder': '例如：改为黑色，或宽度减少 10 厘米。',
  'orderActions.object.submit': '提交修改申请',
  'orderActions.object.sending': '正在提交…',
  'orderActions.object.sent': '修改申请已提交，销售团队会与您联系。',
  'orderActions.object.open': ({ openedAt }) => `有一项修改申请正在等待答复，提交于 ${openedAt}`,
  'orderActions.object.openBody': '在收到答复之前，此订单不会进入生产。如果提交有误，可以撤回。',
  'orderActions.object.withdraw': '撤回修改申请',
  'orderActions.object.withdrawing': '正在撤回…',
  'orderActions.object.withdrawn': '修改申请已撤回。',
  ...
  'orderActions.cancel.refund': ({ refundMinor }, f) => `将退回 ${f.bahtExact(refundMinor)}`,
  'orderActions.cancel.freeCancellation': '可以取消且不扣除任何款项，全额退回。',
  'orderActions.cancel.noMoney': '尚未收到付款，因此没有需要扣除或退回的款项。',
  'orderActions.cancel.reasonLabel': '取消原因',
  'orderActions.cancel.reasonPlaceholder': '例如：改变主意，或项目延期。',
  'orderActions.cancel.confirm': '确认取消',
  'orderActions.cancel.cancelling': '正在取消…',
  'orderActions.cancel.keep': '不取消',
  'orderActions.cancel.done': '此订单已取消。',
  'orderActions.problem.unconfigured': '本站配置尚未完成，请联系我们的销售团队。',
  'orderActions.problem.unreachable': '无法连接系统，请重试。',
  'orderActions.problem.unauthorized': '登录已过期，请重新登录。',
  'orderActions.problem.refused': '无法完成此操作。',
  'orderActions.problem.malformed': '无法读取系统的回复，请重试。',
  ...
  'payment.awaitingConfirmation': '您的报价单正在审核中。所示金额仍为估算 — 我们的团队会确认后再通知您付款。',
