...
/**
 * Deutsch (German) — **untranslated, on purpose.**
 *
 ...
 *
 * So the mechanism is complete and the content is honestly missing. Today a German
 * visitor gets German numbers, German dates, German currency placement — and the message
 ...
 *
 * Set `status: 'translated'` only once a person who reads German has reviewed it. The
