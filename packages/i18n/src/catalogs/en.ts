...
/**
 * English (English) — **untranslated, on purpose.**
 *
 ...
 *
 * So the mechanism is complete and the content is honestly missing. Today a English
 * visitor gets English numbers, English dates, English currency placement — and the message
 ...
 *
 * Set `status: 'translated'` only once a person who reads English has reviewed it. The
