...
/**
 * हिन्दी (Hindi) — **untranslated, on purpose.**
 *
 ...
 *
 * So the mechanism is complete and the content is honestly missing. Today a Hindi
 * visitor gets Hindi numbers, Hindi dates, Hindi currency placement — and the message
 ...
 *
 * Set `status: 'translated'` only once a person who reads Hindi has reviewed it. The
