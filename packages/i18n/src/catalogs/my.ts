...
/**
 * မြန်မာ (Burmese) — **untranslated, on purpose.**
 *
 ...
 *
 * So the mechanism is complete and the content is honestly missing. Today a Burmese
 * visitor gets Burmese numbers, Burmese dates, Burmese currency placement — and the message
 ...
 *
 * Set `status: 'translated'` only once a person who reads Burmese has reviewed it. The
 * status is a claim about provenance and no generator may make it.
 */
export const my: LocaleCatalog = {
  locale: 'my',
  status: 'untranslated',
  messages: {},
};
